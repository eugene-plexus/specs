...
$PIN = @{
    "agent"            = "b4c0679c794b8333bc07851b49e3f9f874079f22"
    "control"          = "f84373cea2856e6543bced4630375e5a88cd4e09"
    ...
    "ui"               = "5ad8d848d763f5618797083ae7523714798b2de6"  # branch `dist`, not `main`
}
$DIST = @{
