...
$PIN = @{
    "agent"            = "f55873f455c61e57894ad955ff869a5f3afce21f"
    "control"          = "119478cb47f2a277e9e4a0758256449661fce381"
    ...
    "ui"               = "70eae59cee5a6c83ada9d43385fceab6c47c355c"  # branch `dist`, not `main`
}
$DIST = @{
