...
$PIN = @{
    "agent"            = "e0ec0fc4de2710d3cc6c7cb84f7774597cc39710"
    "control"          = "2ea881b752201519997031667b7e4adcfb125dbd"
    ...
    "ui"               = "b44c7db1c58fbe64b20e3d50cf51fb723a62d9ee"  # branch `dist`, not `main`
}
$DIST = @{
