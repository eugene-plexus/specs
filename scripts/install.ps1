...
$PIN = @{
    "agent"            = "ef7511daa4caf36eac826b5cedc4b304e54fa2a3"
    "control"          = "c19b2d1a88b7001da3242414ce66af12d3e7032e"
    ...
    "ui"               = "0cd34cb5b41ca9cfd540cfe7d21f0542204da8bf"  # branch `dist`, not `main`
}
$DIST = @{
